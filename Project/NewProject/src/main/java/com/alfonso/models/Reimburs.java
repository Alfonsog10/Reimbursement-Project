...
public class Reimburs {
	...
	public Reimburs (Integer reimb_id, Integer emp_id, Double amount, String reason, String status) {
		super();
	...
	public void add(Reimburs reimbursements) {
		// for mock testing
